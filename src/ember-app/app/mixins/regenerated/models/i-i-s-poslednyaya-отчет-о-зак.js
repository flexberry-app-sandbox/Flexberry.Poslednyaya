...
export let Model = Mixin.create({
  ...
  состОтгрузки: DS.attr('i-i-s-poslednyaya-сост-отгрузки'),
  состояниеОплаты: DS.attr('i-i-s-poslednyaya-сост-оплаты'),
  ...
  тЧЗаказ: DS.hasMany('i-i-s-poslednyaya-т-ч-заказ', { inverse: 'отчетОЗак', async: false })
});
...
export let defineProjections = function (modelClass) {
  modelClass.defineProjection('ОтчетОЗакE', 'i-i-s-poslednyaya-отчет-о-зак', {
    ...
    тЧЗаказ: hasMany('i-i-s-poslednyaya-т-ч-заказ', 'Заказ', {
