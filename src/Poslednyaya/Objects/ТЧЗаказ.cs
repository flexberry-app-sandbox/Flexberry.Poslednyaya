...
namespace IIS.Poslednyaya
{
    ...
    public class ТЧЗаказ : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Poslednyaya.ОтчетОЗак fОтчетОЗак;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Poslednyaya.ОтчетОЗак.
        /// </summary>
        ...
        [TypeUsage(new string[] {
                "IIS.Poslednyaya.ЗаказПост",
                "IIS.Poslednyaya.ОтчетОЗак"})]
        public virtual IIS.Poslednyaya.ОтчетОЗак ОтчетОЗак
        {
            get
            {
                ...
                IIS.Poslednyaya.ОтчетОЗак result = this.fОтчетОЗак;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ТЧЗаказE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТЧЗаказE", typeof(IIS.Poslednyaya.ТЧЗаказ));
                }
            }
        }
    }
    ...
    public class DetailArrayOfТЧЗаказ : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Poslednyaya.DetailArrayOfТЧЗаказ members)

        // *** End programmer edit section *** (IIS.Poslednyaya.DetailArrayOfТЧЗаказ members)
        ...
        /// </summary>
        public DetailArrayOfТЧЗаказ(IIS.Poslednyaya.ОтчетОЗак fОтчетОЗак) : 
                base(typeof(ТЧЗаказ), ((ICSSoft.STORMNET.DataObject)(fОтчетОЗак)))
        {
        }
        
        public IIS.Poslednyaya.ТЧЗаказ this[int index]
        {
            get
            {
                return ((IIS.Poslednyaya.ТЧЗаказ)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Poslednyaya.ТЧЗаказ dataobject)
        {
